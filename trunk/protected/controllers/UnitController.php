...
class UnitController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','getAllUnitCb'),
				'users'=>array('*'),
			),
    ...
    public function actionGetAllUnitCb(){
        $result='';
        $model = Unit::model()->findAll();
        foreach ($model as $object) {
            $result = $result.'<option value="'.$object->Unit_ID.'">'.$object->Unit.'</option>';
        }
        echo $result;
    }
}
