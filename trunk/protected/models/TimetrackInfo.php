...
/**
 * This is the model class for table "timetrack_info".
 *
 * The followings are the available columns in table 'timetrack_info':
 ...
 */
class TimetrackInfo extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return TimetrackInfo the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('JobAssign_ID, Task_ID, Activities_ID, Date, StartTime, EndTime', 'required'),
			array('Timtrack_ID, JobAssign_ID, Task_ID, Activities_ID, Quantity', 'numerical', 'integerOnly'=>true),
			...
			array('Timtrack_ID, JobAssign_ID, ProjectNo, ProjectName, EmpNo, Full_Name, Task_ID, TaskName, Activities_ID, ActivitiesName, Unit, Quantity, Date, StartTime, EndTime, Comment', 'safe', 'on'=>'search'),
		);
	}
