...
<div id="create_computer_content" class="content_main content_main_without_nav" style="margin-top: 10px">
    ...
    <table border="0" style="width: 1000px;margin: auto;">
        ...
        <tr style="height: 100px"><td colspan="4" class="form" style="text-align: center"><button class="bt_large" style="margin-right: 10px" onclick="actionCreateNewComp()">Create</button><button class="bt_large">Cancel</button></td></tr>
    </table>
</div>