...
class IndustryController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','getAllIndustryCb'),
				'users'=>array('*'),
			),
    ...
    public function actionGetAllIndustryCb(){
        $result='';
        $model = Industry::model()->findAll();
        foreach ($model as $object) {
            $result = $result.'<option value="'.$object->Industry_ID.'">'.$object->IndustryName.'</option>';
        }
        echo $result;
    }
}
